...
<head>
  ...
  <title data-ice="title">lib/Logger.js | kayn</title>
...
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">const loggerPrefix = &apos;kayn&apos;
