...
class DDragonProfileIconEndpoint {
    ...
    list() {
        return new _DDragonRequest2.default(this.config, 'profileicon.json', _DDragonRequest.DDragonRequestTypes.CDN.DATA, _methodNames2.default.DDRAGON.PROFILE_ICON_LIST);
    }
}

exports.default = DDragonProfileIconEndpoint;