...
class MasterEndpointV4 extends _LeagueSuperclass2.default {
     ...
     */
    list(queueName) {
        return new _Request2.default(this.config, this.serviceName, `masterleagues/by-queue/${queueName}`, _methodNames2.default.LEAGUE.GET_MASTER_LEAGUE_V4, 'GET', this.limiter, null, false, 4);
    }
}

exports.default = MasterEndpointV4;