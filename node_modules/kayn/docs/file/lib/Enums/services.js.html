...
<head>
  ...
  <title data-ice="title">lib/Enums/services.js | kayn</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">lib/Enums/services.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">const services = {
    CHAMPION: &apos;platform&apos;,
