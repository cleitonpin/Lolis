...
<head>
  ...
  <title data-ice="title">lib/Utils/SetupTTLs.js | kayn</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">lib/Utils/SetupTTLs.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">import SERVICES from &apos;../Enums/services&apos;;
import METHOD_NAMES from &apos;../Enums/method-names&apos;;

function setupTTLs(ttls) {
    const keys = Object.keys(ttls);
    const newTTLs = {};

    if (keys.indexOf(SERVICES.SUMMONER) !== -1) {
        Object.keys(METHOD_NAMES.SUMMONER).forEach(el =&gt; {
            newTTLs[el] = ttls[SERVICES.SUMMONER];
        });
    }
