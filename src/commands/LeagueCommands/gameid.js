...
data = async (id, client) => {
    ...
    if(lost == '' && winner == '') {
        ...
        embed.setDescription([
            `**Time vencedor: ${Teams(winner[0].teamId)}** ${client.emojis.cache.get('729744152681644152')} `,
        ...
        if(infoMtach.teams[0].bans != '') {
            embed.addField(`Bans do time ${time1}`, [
                `${getChampionEmoji(client, infoMtach.teams[0].bans[0].championId)} ${IDtoName(infoMtach.teams[0].bans[0].championId)}`,
                `${getChampionEmoji(client, infoMtach.teams[0].bans[1].championId)} ${IDtoName(infoMtach.teams[0].bans[1].championId)}`,
                `${getChampionEmoji(client, infoMtach.teams[0].bans[2].championId)} ${IDtoName(infoMtach.teams[0].bans[2].championId)}`,
                `${getChampionEmoji(client, infoMtach.teams[0].bans[3].championId)} ${IDtoName(infoMtach.teams[0].bans[3].championId)}`,
                `${getChampionEmoji(client, infoMtach.teams[0].bans[4].championId)} ${IDtoName(infoMtach.teams[0].bans[4].championId)}`
            ], true)
            embed.addField(`Bans do time ${time2}`, [
                `${getChampionEmoji(client, infoMtach.teams[1].bans[0].championId)} ${IDtoName(infoMtach.teams[1].bans[0].championId)}`,
                `${getChampionEmoji(client, infoMtach.teams[1].bans[1].championId)} ${IDtoName(infoMtach.teams[1].bans[1].championId)}`,
                `${getChampionEmoji(client, infoMtach.teams[1].bans[2].championId)} ${IDtoName(infoMtach.teams[1].bans[2].championId)}`,
                `${getChampionEmoji(client, infoMtach.teams[1].bans[3].championId)} ${IDtoName(infoMtach.teams[1].bans[3].championId)}`,
                `${getChampionEmoji(client, infoMtach.teams[1].bans[4].championId)} ${IDtoName(infoMtach.teams[1].bans[4].championId)}`
            ], true)
        ...
        embed.setTitle('Informações detalhadas da partida')
        embed.setDescription([
            `**Time vencedor: ${Teams(lost[0].teamId)}** ${client.emojis.cache.get('729744152681644152')} `,
            `**Modo de jogo: ${gameMode}**`,
            `**Duração da partida: ${tempoPartida.toFixed(0)} minutos**`
        ])
