...
exports.run = async (client, message, args) => {
    ...
    if(CurrentGame.bannedChampions[0].teamId == 100) var teamm = 'Vermelho'
    if(CurrentGame.bannedChampions[1].teamId == 100) var teamm = 'Vermelho'
    if(CurrentGame.bannedChampions[2].teamId == 100) var teamm = 'Vermelho'
    if(CurrentGame.bannedChampions[3].teamId == 100) var teamm = 'Vermelho'
    if(CurrentGame.bannedChampions[4].teamId == 100) var teamm = 'Vermelho'
    if(CurrentGame.bannedChampions[5].teamId == 200) var team2m = 'Azul'
    if(CurrentGame.bannedChampions[6].teamId == 200) var team2m = 'Azul'
    if(CurrentGame.bannedChampions[7].teamId == 200) var team2m = 'Azul'
    if(CurrentGame.bannedChampions[8].teamId == 200) var team2m = 'Azul'
    if(CurrentGame.bannedChampions[9].teamId == 200) var team2m = 'Azul'
    if(CurrentGame.gameMode== 'CLASSIC') var mapa = 'Summoners Rift'

    const embed = new Discord.RichEmbed()
    .setColor('#170B3B')
    .setTitle(`**Partida ao vivo de ${args[0]}**`)
    .addField(`***Time ${team}:***`, `__**${CurrentGame.participants[0].summonerName}**__ de ${checkSkin(CurrentGame.participants[0].championId)}  ${spell1}${spell2}\n__**${CurrentGame.participants[1].summonerName}**__ de ${checkSkin(CurrentGame.participants[1].championId)}  ${PLAY1}${PLAY12}\n__**${CurrentGame.participants[2].summonerName}**__ de ${checkSkin(CurrentGame.participants[2].championId)}  ${spellp3}${spellpp3}\n__**${CurrentGame.participants[3].summonerName}**__ de ${checkSkin(CurrentGame.participants[3].championId)} ${spellp4}${spellpp4}\n__**${CurrentGame.participants[4].summonerName}**__ de ${checkSkin(CurrentGame.participants[4].championId)} ${spellp5}${spellpp0}`, true)
    .addField(`***Time ${team2}:***`, `__**${CurrentGame.participants[5].summonerName}**__ de ${checkSkin(CurrentGame.participants[5].championId)} ${spellp6}${spellpp6}\n__**${CurrentGame.participants[6].summonerName}**__ de ${checkSkin(CurrentGame.participants[7].championId)} ${spellp7}${spellpp7}\n__**${CurrentGame.participants[7].summonerName}**__ de ${checkSkin(CurrentGame.participants[7].championId)} ${spellp8}${spellpp8}\n__**${CurrentGame.participants[8].summonerName}**__ de ${checkSkin(CurrentGame.participants[8].championId)} ${spellp9}${spellpp9}\n__**${CurrentGame.participants[9].summonerName}**__ de ${checkSkin(CurrentGame.participants[9].championId)} ${spellp10}${spellpp10}`, true)
    ...
    .addField('----------------------------------', '\u200b')
    .addField(`Bans do time ${teamm}`, `${Ban1()} ${Ban2()} ${Ban3()} ${Ban4()} ${Ban5()}`, true)
    .addField(`Bans do time ${team2m}`, `${Ban6()} ${Ban7()} ${Ban8()} ${Ban9()} ${Ban10()}` ,true)
