    ...
    if (args[0]){
        ...
        //fim pegar id
            ...
            .callback(function(err, CurrentGame) {
                ...
                part = 0    
                for(; part<=10; part++){
                kayn.League.Entries.by.summonerID(`${CurrentGame.participants[part].summonerId}`)
                ...
                function Player(ID1){
                    part = 0
                    for(; part<=10;part++){
                        switch(CurrentGame.participants[part].championId){
                ...
                function Bans(ID1){
                    bans = 0
                    for(; bans<=10;bans++){
                        switch(CurrentGame.bannedChampions[bans].championId){
                ...
                // @@@@@@@@@@@@@@@@@@@@@@@ RANKED GAME @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                    ...
                    if(CurrentGame.participants[i].spell1Id == 1) var spell1 = client.emojis.get("631195262194417694")
                        else if(CurrentGame.participants[i].spell1Id == 7) var spell1 = client.emojis.get("63119526437113391")
                ...
                tim= 0
                for(; tim <=10; tim++){
                    if(CurrentGame.participants[tim].teamId == 100) var team = 'Vermelho'
                    if(CurrentGame.participants[tim].teamId == 200) var team = 'Azul'
                }
                
                for(; tim <=10; tim++){
                    if(CurrentGame.bannedChampions[tim].teamId == 100) var team = 'Vermelho'
                    if(CurrentGame.bannedChampions[tim].teamId == 200) var team = 'Azul'
                }
                ...
                .addField(`***Time ${team}:***`, `__**${CurrentGame.participants[0].summonerName}**__ de ${Player()}  ${spell1}${spell2}\n__**${CurrentGame.participants[1].summonerName}**__ de ${Player()}  ${spell1}${spell2}\n__**${CurrentGame.participants[2].summonerName}**__ de ${Player()}  ${spell1}${spell2}\n__**${CurrentGame.participants[3].summonerName}**__ de ${Player()} ${spell1}${spell2}\n__**${CurrentGame.participants[4].summonerName}**__ de ${Player()} ${spell1}${spell2}`, true)
                .addField(`***Time ${team2}:***`, `__**${CurrentGame.participants[5].summonerName}**__ de ${Player()} ${spell1}${spell2}\n__**${CurrentGame.participants[6].summonerName}**__ de ${Player()} ${spell1}${spell2}\n__**${CurrentGame.participants[7].summonerName}**__ de ${Player()} ${spell1}${spell2}\n__**${CurrentGame.participants[8].summonerName}**__ de ${Player()} ${spell1}${spell2}\n__**${CurrentGame.participants[9].summonerName}**__ de ${Player()} ${spell1}${spell2}`, true)
