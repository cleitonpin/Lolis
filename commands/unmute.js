...
exports.run = async (client, message, args, con) => {
    ...
    if(!message.member.hasPermission("MANAGE_ROLES") || !message.guild.owner) return message.channel.send('Você não tem permissão para usar este comando.')
    ...
    if(!mute) return message.channel.send("Mutado")
    ...
    if(!muterole) return message.channel.send("Desmutado!")
